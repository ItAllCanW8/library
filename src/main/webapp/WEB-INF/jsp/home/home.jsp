...
<%--            <div class="box b1">--%>
<%--                <div class="img-box">--%>
<%--                    <img src="${pageContext.request.contextPath}/images/layout/award.png" alt="" />--%>
<%--                </div>--%>
<%--                <div class="detail-box">--%>
<%--                    <h4>--%>
<%--                        BEST <br />--%>
...
<%--            <div class="box b2">--%>
<%--                <div class="img-box">--%>
<%--                    <img src="${pageContext.request.contextPath}/images/layout/study.png" alt="" />--%>
<%--                </div>--%>
<%--                <div class="detail-box">--%>
<%--                    <h4>--%>
<%--                        LEARN <br />--%>
...
<%--            <div class="box b3">--%>
<%--                <div class="img-box">--%>
<%--                    <img src="${pageContext.request.contextPath}/images/layout/books-stack-of-three.png" alt="" />--%>
<%--                </div>--%>
<%--                <div class="detail-box">--%>
<%--                    <h4>--%>
<%--                        BEST <br />--%>
...
<%--                        <img src="${pageContext.request.contextPath}/images/layout/a-1.jpg" alt="" />--%>
<%--                    </div>--%>
<%--                    <div class="img-box b2">--%>
<%--                        <img src="${pageContext.request.contextPath}/images/layout/a-2.jpg" alt="" />--%>
<%--                    </div>--%>
<%--                </div>--%>
<%--            </div>--%>
<%--            <div class="col-md-6">--%>
...
<%--                    <div class="box">--%>
<%--                        <div class="img-box">--%>
<%--                            <img src="${pageContext.request.contextPath}/images/layout/client.png" alt="" />--%>
<%--                        </div>--%>
<%--                        <div class="detail-box">--%>
<%--                            <h5>--%>
<%--                                Distracted by--%>
